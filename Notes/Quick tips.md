...
- Add the following lines in package.json (after installing vite = npm i vite):
...
- This will help to start the server automatically without refreshing after changes.

## **2. Receive/Upload files using form:**
